...
<div class="page-container">
	<span id="toolbar" class="l">
		    ...
		    <a href="javascript:;" onclick="base_add('添加基础数据','baseData/edit.do','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加基础数据</a>
	 </span>
	<table id="dataTable">
...
/*基础数据-编辑*/
function base_edit(baseId){
	layer_show('添加基础数据','baseData/edit.do'+'?baseId='+baseId,'800','500');
}
/*基础数据-删除*/
