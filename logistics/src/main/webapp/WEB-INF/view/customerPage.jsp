...
<div class="page-container">
	<span id="toolbar" class="l">
		   ...
		   <shiro:hasPermission name="customer:insert">
		    	<a href="javascript:;" onclick="base_add('添加基础数据','customer/edit.do','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加基础数据</a>
			</shiro:hasPermission>
	 </span>
	<table id="dataTable">
...
/*基础数据-编辑*/
function base_edit(customerId){
	layer_show('添加基础数据','customer/edit.do'+'?customerId='+customerId,'800','500');
}
/*基础数据-删除*/
...
// 	先接受选择的所有
	...
	checkList.forEach(function(element,index){
		delList.push(element.customerId);
	})
	base_del(delList)
}
</script>
