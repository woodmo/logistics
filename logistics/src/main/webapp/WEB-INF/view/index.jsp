		...
		<div class="navbar navbar-fixed-top">
			<div class="container-fluid cl">
				<a class="logo navbar-logo f-l mr-10 hidden-xs"
					href="/aboutHui.shtml">NGS物流管理系统</a> <a
				...
				<nav id="Hui-userbar"
					...
					<ul class="cl">
						...
						<li class="dropDown dropDown_hover"><a href="#"
							class="dropDown_A"><shiro:principal property="realname" /> <i
	...
	<aside class="Hui-aside">
		<div class="menu_dropdown bk_2">
					...
					<dd>
						<ul>
							<shiro:hasPermission name="admin:adminPage">
								<li><a data-href="admin/adminPage.do" data-title="管理员列表"
							...
							<shiro:hasPermission name="permission:permissionPage">
								<li><a data-href="permission/permissionPage.do"
			...
			<dl id="menu-system">
				...
				<dd>
					<ul>
						<li><a data-href="baseData/baseDataPage.do" data-title="系统设置"
							href="javascript:void(0)">基础数据</a></li>
				...
				<dd>
					<ul>
						<li><a data-href="customer/customerPage.do" data-title="系统设置"
