...
<body>
	...
	<div class="page-container">
		<span id="toolbar" class="l"> <a href="javascript:;"
			...
			onclick="role_add('添加角色','role/edit.do','800','500')"
...
// 		菜单格式化
		function menuTypeFormatter(value, row, index) {
			var html = '<span style="color:blue">普通角色</span>';
			if(value=="menu"){
				html = '<span style="color:red">菜单角色</span>';
			}
			return html;
		}
		/*
		...
		function operationFormatter(value, row, index) {
			var html = '<a title="编辑" href="javascript:;" onclick="role_edit('
					+ value
					+ ')" style="text-decoration:none"><i class="Hui-iconfont"></i></a>';
			html += '<a title="删除" href="javascript:;" onclick="role_del('
					+ value
		...
		function role_edit(roleId) {
			layer_show('添加角色',
					'role/edit.do' + '?roleId=' + roleId, '800',
					'500');
		}
		/*角色-删除*/

		function role_del(data) {
